...
function HomePageContent() {
  ...
  }, [observatoryActive, safe.isDesktop]);
  ...
  return (
    <main className="relative isolate h-full min-h-screen w-full max-w-full overflow-x-hidden overflow-y-hidden" style={{ backgroundColor: "#030405" }}>
      ...
      {showUI && (
        <div
          className={`absolute right-3 top-3 flex flex-col items-end gap-1.5 md:top-6 md:flex-row md:items-center md:gap-2 ${showSettings ? "z-50" : "z-40"}`}
          style={
        ...
        >
          <button
            ...
            className="flex min-h-9 min-w-9 items-center justify-center rounded border border-copper/35 bg-bg/75 px-2 text-copperSoft backdrop-blur-sm hover:border-copper md:min-h-11 md:min-w-11"
            aria-label="Refresh experience"
            title="Refresh experience"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden className="md:h-[18px] md:w-[18px]">
              <path d="M21 2v6h-6" />
